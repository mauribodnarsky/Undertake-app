	...
	if (isset($_GET['mesa'])){
		...
		$pedidos= $pedido->obtenerfactura($comanda);
    ...
    <th style=\"vertical-align: middle;padding:8px;text-align:center;\">FECHA</th>
	<th style=\"vertical-align: middle;padding:8px;text-align:center;\">PRODUCTO</th>
   <th style=\"vertical-align: middle;padding:8px;text-align:center;\">PRECIO</th>
   <th style=\"vertical-align: middle;padding:8px;text-align:center;\">CANTIDAD</th>
   <th style=\"vertical-align: middle;padding:8px;text-align:center;\">SUBTOTAL</th>
   <th style=\"vertical-align: middle;padding:8px;text-align:center;\">CLIENTE</th>

  </tr></thead><tbody>";
	foreach ($pedidos as $key => $value) {
	$html.="<tr style=\"background:white;vertical-align: middle;\"><td style=\"padding:4px;\">".$value['fecha_pedido']."</td><td style=\"padding:4px;\">".$value['producto']."</td><td style=\"padding:4px;\">".$value['precio']."</td><td style=\"padding:4px;\">".$value['cantidad']."</td><td style=\"padding:4px;\">".$value['subtotal']."</td><td style=\"padding:4px;\">".$value['cliente']."</td></tr>";
	}
